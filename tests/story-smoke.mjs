...
assert.match(appSource, /contentRevision: 8/, "旧存档应迁移到镜头化序章与累积结局新版");
...
assert.match(html, /styles\.css\?v=director-8/, "镜头化叙事样式必须使用独立缓存版本");
assert.match(html, /app\.js\?v=director-8/, "镜头化叙事脚本必须使用独立缓存版本");
