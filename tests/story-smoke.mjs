...
assert.match(appSource, /contentRevision: 10/, "旧存档应迁移到两赛季、董事会信任与自由市场新版");
...
assert.match(html, /styles\.css\?v=two-year-13/, "两年任期样式必须使用独立缓存版本");
assert.match(html, /app\.js\?v=two-year-13/, "两年任期脚本必须使用独立缓存版本");
